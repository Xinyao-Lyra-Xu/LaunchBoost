...
describe("Banner 可见性", () => {
  ...
  // ── 最高概率 Bug ──────────────────────────────────────────────────────
  test("[BUG?] 链存在 task.chain 而非 meta.chains 时 → getActiveChain() 返回 null → banner 永久隐藏", async () => {
